...
<html lang="en" with-selection-styled>
  <head>
    ...
    <title>Copy From Lazy Invoice · By Adam Schwartz · Powered by Cloudflare Workers®</title>
    ...
    <meta property="og:url" content="https://pdf.luckin.workers.dev">
    ...
    <meta name="twitter:url" content="https://pdf.luckin.workers.dev">
    ...
    <style>
      ...
      @media (max-width: 319px) {
        .PDFluckinLogo > .PDFluckinLogo--muted {
          display: none;
        }
      }
  ...
  <body>
    <div class="Surface">
      <div class="Panel">
        <div class="Panel--top">
          <h1><a href="https://pdf.luckin.workers.dev" class="Link Link-without-underline"><span class="PDFluckinLogo"><span>pdf.luckin</span><span class="PDFluckinLogo--muted">.workers.dev</span></span></a></h1>
